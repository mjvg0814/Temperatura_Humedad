...
if uploaded_file is not None:
    try:
        ...
        with tab1:
            st.markdown(
                "<h2 style='font-family: Segoe UI, Trebuchet MS, sans-serif; font-size: 2rem; font-weight: 700; color: #265121; text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.25);'>📈 Visualización</h2>",
                unsafe_allow_html=True
            )
            st.markdown("""
